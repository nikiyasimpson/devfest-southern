...
const conduct = () => (
  <Layout>
    <Section>
      ...
      <p>A primary goal of GDG Lviv is to be inclusive to the largest number of contributors, with the most varied and diverse backgrounds possible. As such, we are committed to providing a friendly, safe and welcoming environment for all, regardless of gender, sexual orientation, ability, ethnicity, socioeconomic status, and religion (or lack thereof). GDG Lviv prides itself on being an open, respectful, and inclusive community. That means the jerky behavior isn’t allowed at GDG meetings.
      ...
      <strong>2. Open [Source/Culture/Tech] Citizenship</strong>
      <p>A supplemental goal of this Code of Conduct is to increase open [source/culture/tech] citizenship by encouraging participants to recognize and strengthen the relationships between our actions and their effects on our community. Communities mirror the societies in which they exist, and positive action is essential to counteract the many forms of inequality and abuses of power that exist in society. If you see someone who is making an extra effort to ensure our community is welcoming, friendly, and encourages all participants to contribute to the fullest extent, we want to know.</p>
...
<ul>
  ...
  <li>Attempt collaboration before a conflict.</li>
  <li>Refrain from demeaning, discriminatory, or harassing behavior and speech.</li>
  <li>Be mindful of your surroundings and your fellow participants. Alert community leaders if you notice a dangerous situation, someone in distress, or violations of this Code of Conduct, even if they seem inconsequential.</li>
</ul>

      <strong>4. Unacceptable Behavior</strong>
      <p>The following actions are considered harassment and are unacceptable within our community:</p>
<ul>
  ...
  <li>Sustained disruption of community events, including talks and, presentations.</li>
      ...
      <strong>5. Consequences of Unacceptable Behavior</strong>
      <p>
