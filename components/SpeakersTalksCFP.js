...
export default () => (
  <Section color="blue">
    ...
    <p>The CFP closes on September 6, 2019.</p>
    <p className="cta">
      <AnchorButton color="white/blue" href="https://www.papercall.io/devfest-houston/" target="_blank" rel="noopener noreferrer">Submit your talk</AnchorButton>
    </p>
  </Section>
)
